package com.indosoft.binder.CodeClasses;
...
public class Variables {
    ...
    public static String gif_api_key1="1RzlJkNMz62DCRlVTy3hdA9ZQOWiOXyl";
    ...
    public static String domain="https://fando.xyz/minder/API/index.php?p=";
    public static String image_base_url="https://fando.xyz/minder/API/";


     public static final String TWILIO_ACCESS_TOKEN_SERVER = "https://grullo-nightingale-4944.twil.io/video-token?identity=userid?roomname=roomname";
